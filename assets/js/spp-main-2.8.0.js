...
! function() {
    ...
    function n(t, e) {
        if ("undefined" != typeof AP_Player && AP_Player.debug_output) {
            var i = "";
            void 0 !== e && (i = e.replace(/<br \/>/g, "%lineBreak%"), i = jQuery(i).text(), i = i.replace(/%lineBreak%/g, "\n\t")), console.log("SPP: " + t + i)
        }
    }

    function a(t) {
        if ("elapsed" !== t.type && "remaining" !== t.type) return void n("Invalid user trigger type");
        if (void 0 !== t.player_uid && void 0 === SmartPodcastPlayer._by_uid[t.player_uid]) return void n("Player UID " + t.player_uid + " doesn't exist.");
        if ("function" != typeof t.callback) return void n("Invalid callback");
        if (void 0 === t.seconds || isNaN(parseFloat(t.seconds)) || !isFinite(t.seconds)) return void n("Invalid number of seconds: " + t.seconds);
        var e = {
            type: t.type,
            callback: t.callback,
            seconds: t.seconds,
        ...
        if (void 0 === t.player_uid)
            for (var i in SmartPodcastPlayer._by_uid) SmartPodcastPlayer._by_uid[i].userTriggers.push(e);
        else SmartPodcastPlayer._by_uid[t.player_uid].userTriggers.push(e)
    }
    ...
    ! function(t) {
        ...
        function() {
            ...
            es: {
                ...
                Share: "Compartir",
                of: "de",
                "Sign up to receive email updates": "Regístrese para recibir actualizaciones por email",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "Insertar su nombre y apellidos abajo y te enviare actualizaciones periódicas sobre el podcast",
                Name: "Nombre",
                "Email Address": "Dirección de email",
                "First Name": "Primer nombre",
                "Last Name": "Apellido",
                Close: "Cerrar",
                "Send Me Updates": "Envíarme actualizaciones",
                "An error occurred while signing you up.  The message is:": "Ha ocurrido un error mientras se registraba. El mensaje es:",
                "Thanks! You'll be hearing from us soon.": "Gracias. Sabras de nosotros pronto",
                "You're already subscribed to this list.  Thanks!": "Ya estas inscrito en esta lista; Gracias!",
                "You should receive an email confirmation soon.": "Recibirás un email de confirmación en breve"
            },
            fr: {
                Search: "Rechercher",
                ...
                Share: "Partager",
                of: "de",
                "Sign up to receive email updates": "Inscrivez-vous pour recevoir des mises à jour par courriel",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "Entrez votre nom et votre adresse électronique ci-dessous et je vous enverrai des mises à jour périodiques sur le podcast.",
                Name: "le nom",
                "Email Address": "Votre email",
                "First Name": "Votre prénom",
                "Last Name": "Nom de famille",
                Close: "Fermer",
                "Send Me Updates": "M'envoyer des mises à jour",
                "An error occurred while signing you up.  The message is:": "Une erreur s'est produite lors de votre inscription. Le message est:",
                "Thanks! You'll be hearing from us soon.": "Merci! Vous allez bientôt entendre parler de nous.",
                "You're already subscribed to this list.  Thanks!": "Vous êtes déjà inscrit à cette liste. Merci!",
                "You should receive an email confirmation soon.": "Vous devriez bientôt recevoir une confirmation par courrier électronique"
            },
            it: {
                Search: "Ricerca",
                Download: "Scarica",
                ...
                Details: "Dettagli",
                "Episode Details": "Dettagli della puntata",
                more: "Di Più",
                Share: "Partecipare",
                of: "di",
                "Sign up to receive email updates": "Iscriviti per ricevere aggiornamenti via email",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "Inserisci il tuo nome e indirizzo e-mail qui sotto e ti invierò aggiornamenti periodici sul podcast.",
                Name: "il nome",
                ...
                "An error occurred while signing you up.  The message is:": "Si è verificato un errore durante la firma. Il messaggio è:",
                "Thanks! You'll be hearing from us soon.": "Grazie! Sarai ascoltato da noi presto.",
                "You're already subscribed to this list.  Thanks!": "Sei già iscritto a questo elenco. Grazie!",
                "You should receive an email confirmation soon.": "Bisogna ricevere presto una conferma via email."
            },
            pt: {
                Search: "Pesquisar",
                Download: "Baixar",
                ...
                Share: "Compartilhar",
                of: "de",
                "Sign up to receive email updates": "Inscreva-se para receber atualizações de e-mail",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "Digite seu nome e endereço de e-mail abaixo e eu lhe enviarei atualizações periódicas sobre o podcast.",
                Name: "o nome",
                "Email Address": "endereço de e-mail",
                "First Name": "o primeiro nome",
                "Last Name": "o sobrenome",
                Close: "fechar",
                "Send Me Updates": "Me envie atualizações",
                "An error occurred while signing you up.  The message is:": "Ocorreu um erro ao assinar você. A mensagem é:",
                "Thanks! You'll be hearing from us soon.": "Obrigado! Você vai ter notícias de nós em breve.",
                "You're already subscribed to this list.  Thanks!": "Você já está inscrito nesta lista. Obrigado!",
                "You should receive an email confirmation soon.": "Você deve receber uma confirmação de e-mail em breve."
            },
            ru: {
                Search: "поиск",
                Download: "скачать",
                ...
                Details: "Детали",
                "Episode Details": "Эпизод",
                more: "Больше",
                Share: "делиться",
                of: "из",
                "Sign up to receive email updates": "Зарегистрируйтесь, чтобы получать обновления по электронной почте",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "Введите свое имя и адрес электронной почты ниже, и я пришлю вам периодические обновления о подкасте.",
                Name: "название",
                "Email Address": "адрес электронной почты",
                "First Name": "имя",
                "Last Name": "Фамилия",
                Close: "кончать",
                "Send Me Updates": "Отправить мне обновления",
                "An error occurred while signing you up.  The message is:": "Произошла ошибка при подписании вами. Это сообщение:",
                "Thanks! You'll be hearing from us soon.": "Благодаря! Вы скоро услышите от нас.",
                "You're already subscribed to this list.  Thanks!": "Вы уже подписаны на этот список. Благодаря!",
                "You should receive an email confirmation soon.": "Вскоре вы получите подтверждение по электронной почте."
            },
            pl: {
                Search: "Poszukiwanie",
                Download: "pobieranie",
                ...
                Details: "Detale",
                "Episode Details": "Szczegóły epizodu",
                more: "dalszy",
                Share: "Podzielać",
                of: "z",
                "Sign up to receive email updates": "Zarejestruj się, aby otrzymywać aktualizacje e-mailowe",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "Podaj swoje imię i adres e-mail poniżej i wysyłam Ci okresowe aktualizacje podcastu.",
                Name: "Nazwa",
                "Email Address": "Adres e-mail",
                "First Name": "pierwsze imię",
                "Last Name": "nazwisko",
                Close: "domknąć",
                "Send Me Updates": "Wyślij aktualizacje",
                "An error occurred while signing you up.  The message is:": "Podczas rejestrowania wystąpił błąd. Wiadomość jest:",
                "Thanks! You'll be hearing from us soon.": "Dzięki! Już wkrótce usłyszysz od nas.",
                "You're already subscribed to this list.  Thanks!": "Jesteś już zapisany do tej listy. Dzięki!",
                "You should receive an email confirmation soon.": "Wkrótce otrzymasz e-maila z potwierdzeniem"
            },
            de: {
                Search: "Suchen",
                ...
                Subscribe: "Tilaa",
                Episodes: "Jaksot",
                "Now Playing": "Soitetaan",
                Details: "Tiedot",
                "Episode Details": "Jakson tiedot",
                more: "lisää",
                Share: "Jaa",
                of: "/",
                "Sign up to receive email updates": "Rekisteröidy sähköpostilistallemme",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "Kirjoita alle nimesi ja sähköpostiosoitteesi, niin saat jatkossa tiedon uusista jaksoista suoraan sähköpostiisi",
                Name: "Nimi",
                "Email Address": "Sähköpostiosoite",
                "First Name": "Etunimi",
                "Last Name": "Sukunimi",
                Close: "Sulje",
                "Send Me Updates": "Haluan uutiskirjeenne",
                "An error occurred while signing you up. The message is:": "Rekisteröitymisessä tapahtui virhe. Virheilmoitus:",
                "Thanks! You'll be hearing from us soon.": "Kiitos! Kuulet meistä piakkoin.",
                "You're already subscribed to this list. Thanks!": "Olet jo rekisteröitynyt. Kiitos!",
                "You should receive an email confirmation soon.": "Saat pian vahvistuslinkin sähköpostiisi."
            },
            ar: {
                Search: "بحث",
                Download: "تحميل",
                Subscribe: "اشترك",
                Episodes: "الحلقات",
                "Now Playing": "جاري القراءة",
                Details: "التفاصيل",
                "Episode Details": "تفاصيل الحلقة",
                more: "أكثر",
                Share: "شارك",
                of: "من",
                "Sign up to receive email updates": "قم بالتسجيل لتستلم تحديث الايميل",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "أدخل اسمك وعنوان بريدك الإلكتروني أدناه وسأرسل إليك تحديثات دورية حول البودكاست.",
                Name: "اسم",
                "Email Address": "عنوان البريد الإلكتروني",
                "First Name": "الاسم الخاص",
                "Last Name": "اسم العائلة",
                Close: "أغلق",
                "Send Me Updates": "أرسل لي التحديثات",
                "An error occurred while signing you up.  The message is:": "حدث خطأ أثناء تسجيل دخولك. الرسالة هي:",
                "Thanks! You'll be hearing from us soon.": "شكر! عليك أن تسمع منا قريبا.",
                "You're already subscribed to this list.  Thanks!": "أنت مشترك بالفعل في هذه القائمة. شكر!",
                "You should receive an email confirmation soon.": "يجب أن تتلقى رسالة تأكيد بالبريد الإلكتروني قريبا."
            },
            hi: {
                Search: "खोज",
                Download: "डाउनलोड",
                Subscribe: "सदस्यता के",
                Episodes: "एपिसोड",
                "Now Playing": "अभी खेल रहे है",
                Details: "विवरण",
                "Episode Details": "प्रकरण विवरण",
                more: "और",
                Share: "बँटना",
                of: "में से",
                "Sign up to receive email updates": "ईमेल अपडेट प्राप्त करने के लिए साइन अप करें",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "नीचे अपना नाम और ईमेल पता दर्ज करें और मैं आपको पॉडकास्ट के बारे में आवधिक अपडेट भेजूंगा।",
                Name: "नाम",
                "Email Address": "ई-मेल एड्रेस",
                "First Name": "पहला नाम",
                "Last Name": "अंतिम नाम",
                Close: "समाप्त करना",
                "Send Me Updates": "मुझे अपडेट भेजें",
                "An error occurred while signing you up.  The message is:": "आपको साइन अप करते समय एक त्रुटि हुई संदेश है:",
                "Thanks! You'll be hearing from us soon.": "धन्यवाद! आप जल्द ही हमारी ओर से सुनेंगे",
                "You're already subscribed to this list.  Thanks!": "आप पहले से ही इस सूची में सदस्यता ले चुके हैं। धन्यवाद!",
                "You should receive an email confirmation soon.": "आपको शीघ्र ही एक ईमेल पुष्टि प्राप्त होनी चाहिए"
            },
            zh: {
                Search: "搜索",
                Download: "下载",
                ...
                "Now Playing": "廣播中",
                Details: "细节",
                "Episode Details": "剧集细节",
                more: "更多",
                Share: "分享",
                of: "的",
                "Sign up to receive email updates": "注册接收电子邮件更新",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "在下面输入您的姓名和电子邮件地址，我们会定期向您发送有关播客的更新。",
                Name: "名称",
                "Email Address": "电子邮件",
                "First Name": "名字",
                "Last Name": "姓",
                Close: "关闭",
                "Send Me Updates": "发送我更新",
                "An error occurred while signing you up.  The message is:": "注册时发生错误。消息是：",
                "Thanks! You'll be hearing from us soon.": "谢谢！你会很快听到我们的声音。",
                "You're already subscribed to this list.  Thanks!": "您已经订阅了此列表。谢谢！",
                "You should receive an email confirmation soon.": "您应该很快收到一封电子邮件确认。"
            },
            ja: {
                Search: "検索",
                Download: "ダウンロード",
                ...
                Share: "分け合う",
                of: "の",
                "Sign up to receive email updates": "電子メールの更新を受け取るためにサインアップする",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "下にあなたの名前とEメールアドレスを入力してください。ポッドキャストに関する定期的なアップデートをお送りします。",
                Name: "名",
                "Email Address": "電子メールアドレス",
                "First Name": "ファーストネーム",
                "Last Name": "苗字",
                Close: "閉じる",
                "Send Me Updates": "アップデートを送信する",
                "An error occurred while signing you up.  The message is:": "サインアップ中にエラーが発生しました。メッセージは次のとおりです。",
                "Thanks! You'll be hearing from us soon.": "ありがとう！あなたは私たちからすぐに聞くでしょう。",
                "You're already subscribed to this list.  Thanks!": "既にこのリストに登録しています。ありがとう！",
                "You should receive an email confirmation soon.": "すぐに確認メールが届きます。"
            },
            bn: {
                Search: "অনুসন্ধান",
                Download: "ডাউনলোড",
                ...
                Details: "বিস্তারিত",
                "Episode Details": "পর্বের বিবরণ",
                more: "অধিক",
                Share: "অংশ দেত্তয়া",
                of: "এর",
                "Sign up to receive email updates": "ইমেল আপডেটগুলি পেতে সাইন আপ করুন",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "নীচের আপনার নাম এবং ইমেল ঠিকানা লিখুন এবং আমি পডকাস্ট সম্পর্কে আপনি নিয়মিত আপডেট পাঠাতে হবে।",
                Name: "নাম",
                "Email Address": "পর্বের বিবরণ",
                "First Name": "নামের প্রথমাংশ",
                "Last Name": "পদবি",
                Close: "বন্ধ করা",
                "Send Me Updates": "আমাকে আপডেট পাঠান",
                "An error occurred while signing you up.  The message is:": "আপনাকে সাইন ইন করার সময় একটি ত্রুটি ঘটেছে। বার্তাটি হল:",
                "Thanks! You'll be hearing from us soon.": "ধন্যবাদ! আপনি শীঘ্রই আমাদের কাছ থেকে শুনতে হবে",
                "You're already subscribed to this list.  Thanks!": "আপনি ইতিমধ্যে এই তালিকা সাবস্ক্রাইব করছি। ধন্যবাদ!",
                "You should receive an email confirmation soon.": "আপনি শীঘ্রই একটি ইমেল নিশ্চয়তা পাবেন।"
            },
            sv: {
                Search: "söka",
                Download: "ladda ner",
                ...
                Details: "detaljer",
                "Episode Details": "episod detaljer",
                more: "mera",
                Share: "dela",
                of: "av",
                "Sign up to receive email updates": "Registrera dig för att få e-postuppdateringar",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "Ange ditt namn och din e-postadress nedan och jag skickar dig periodiska uppdateringar om podcasten.",
                Name: "namn",
                "Email Address": "e-postadress",
                "First Name": "förnamn",
                "Last Name": "efternamn",
                Close: "stänga",
                "Send Me Updates": "skicka mig uppdateringar",
                "An error occurred while signing you up.  The message is:": "Ett fel uppstod när du loggade på dig. Meddelandet är:",
                "Thanks! You'll be hearing from us soon.": "Tack! Du kommer snart att höra från oss.",
                "You're already subscribed to this list.  Thanks!": "Du har redan prenumererat på den här listan. Tack!",
                "You should receive an email confirmation soon.": "Du borde snart få en bekräftelse på e-post."
            },
            el: {
                Search: "ψάχνω",
                Download: "Κατεβάστε",
                ...
                Share: "μοιράζω",
                of: "του",
                "Sign up to receive email updates": "εγγραφείτε για να λαμβάνετε ενημερώσεις ηλεκτρονικού ταχυδρομείου",
                "Enter your name and email address below and I'll send you periodic updates about the podcast.": "Εισαγάγετε το όνομα και τη διεύθυνση ηλεκτρονικού ταχυδρομείου παρακάτω και θα σας στείλουμε περιοδικές ενημερώσεις σχετικά με το podcast",
                Name: "όνομα",
                "Email Address": "ηλεκτρονική διεύθυνσή",
                "First Name": "μικρό όνομα",
                "Last Name": "επίθετο",
                Close: "κλείνω",
                "Send Me Updates": "στείλτε μου ενημερώσεις",
                "An error occurred while signing you up.  The message is:": "Παρουσιάστηκε σφάλμα κατά την υπογραφή σας. Το μήνυμα είναι:",
                "Thanks! You'll be hearing from us soon.": "Ευχαριστώ! Θα μας ακούσετε σύντομα.",
                "You're already subscribed to this list.  Thanks!": "Έχετε ήδη εγγραφεί σε αυτήν τη λίστα. Ευχαριστώ!",
                "You should receive an email confirmation soon.": "Θα πρέπει να λάβετε σύντομα μια επιβεβαίωση μέσω ηλεκτρονικού ταχυδρομείου."
            }
            ...
            return t.module("Dss", function(t, s, n, a, o, r) {
                ...
                t.DssLayout = a.Layout.extend({
                    ...
                    onRender: function() {
                        ...
                        if (t.isSticky) return void("dark" == t.style && this.$el.addClass("spp-dark"));
                        var e = 0;
                        t.social_facebook && "false" !== t.social_facebook && e++, t.social_twitter && "false" !== t.social_twitter && e++, t.social_gplus && "false" !== t.social_gplus && e++, t.social_linkedin && "false" !== t.social_linkedin && e++, t.social_pinterest && "false" !== t.social_pinterest && e++, t.social_email && "false" !== t.social_email && e++;
                        var i = "14%";
                        6 == e ? i = "14%" : 5 == e ? i = "17%" : 4 == e ? i = "22%" : 3 == e ? i = "22%" : 2 == e ? i = "29%" : 1 == e && (i = "45%"), this.$(".spp-share-icon-container1").cssExtended("max-width", i, AP_Player.importantStr), this.$(".spp-share-icon-container").cssExtended("max-width", i, AP_Player.importantStr)
                    },
                    onShow: function() {
                        var t = this.model.get("data");
                        if (t.isSticky) null !== t.show_logo && void 0 !== t.show_logo || this.$el.closest(".spp-dsst-region").addClass("spp-no-image"), this.$(".spp-dsst-icon-list-outer").jScrollPane(), this.$(".spp-dsst-row").each(function() {
                            var t = 0;
                            ...
                            for (var e = 0, i = 0; i < u.length; i++) t["subscribe_" + u[i][0]] && (e += 1);
                            var s = this.$(".spp-dss-subscribe-text").innerWidth(),
                                n = this.$(".spp-dss-subscribe-text").closest(".spp-dss-row"),
                                a = Math.floor(s / 36);
                            n.removeClass("spp-dss-row-double"), n.removeClass("spp-dss-row-triple"), e > 2 * a ? n.addClass("spp-dss-row-triple") : e > a && n.addClass("spp-dss-row-double")
                        }
                    },
                    ...
                    unblock: function() {
                        if (this.model.get("data").isSticky) o.unblockUI();
                        else {
                            var t = this.$el.closest(".spp-player-layout");
                            t.children(".blockUI").length > 0 && (t.unblock(), t.find(".spp-more").first().find(".spp-control").focus())
                        }
                    },
                    showIcons: function(t) {
                        this.model.get("data").isSticky || o(t.currentTarget).hasClass("spp-show-icons") || (this.$el.find(".spp-dss-row").removeClass("spp-show-icons"), o(t.currentTarget).addClass("spp-show-icons"), o(t.currentTarget).find(".spp-control").attr("tabindex", "0"), t.preventDefault())
                    },
                    hideIcons: function(t) {
                        this.model.get("data").isSticky || o(t.currentTarget).hasClass("spp-show-icons") && (o(t.currentTarget).removeClass("spp-show-icons"), o(t.currentTarget).find(".spp-control").removeAttr("tabindex"), t.preventDefault())
                    },
                    toggleIcons: function(t) {
                        this.model.get("data").isSticky || (o(t.currentTarget).hasClass("spp-show-icons") ? this.hideIcons(t) : this.showIcons(t))
                    },
                    socialPopup: function(t) {
                        window.open(t, "pinterest", "screenX=100,screenY=100,height=360,width=730")
                    },
                    shareButtonClick: function(t) {
                        var e, i = this,
                            s = i.model.get("data"),
                            n = o(t.currentTarget);
                        if (e = s.permalink ? s.permalink : window.location.href, n.hasClass("spp-facebook") && this.socialPopup("http://www.facebook.com/sharer/sharer.php?m2w&s=100&p[url]=" + encodeURIComponent(e) + "&p[images][0]=&p[title]=" + encodeURIComponent(s.title)), n.hasClass("spp-twitter")) {
                            var a = "https://twitter.com/intent/tweet?";
                            if (s.tweet_text ? a += "text=" + encodeURIComponent(s.tweet_text) : a += "text=" + encodeURIComponent(s.title), a += "&url=" + encodeURIComponent(e), s.hashtag) {
                                a += "&hashtags=";
                                for (var r = s.hashtag.split(","), l = 0; l < r.length; l++) a += encodeURIComponent(r[l].replace("#", "")) + ","
                            }
                            s.twitter_username && (a += "&via=" + encodeURIComponent(s.twitter_username.replace("@", ""))), this.socialPopup(a)
                        }
                        n.hasClass("spp-linked-in") && this.socialPopup("https://www.linkedin.com/shareArticle?mini=true&url=" + encodeURIComponent(e) + "&title=" + encodeURIComponent(s.title)), n.hasClass("spp-google-plus") && this.socialPopup("https://plus.google.com/share?url=" + encodeURIComponent(e)), n.hasClass("spp-pinterest") && this.socialPopup("https://pinterest.com/pin/create/button/?url=" + encodeURIComponent(e)), n.hasClass("spp-stumble") && this.socialPopup("http://www.stumbleupon.com/submit?url=" + encodeURIComponent(e) + "&title=" + encodeURIComponent(s.title))
                    },
                    ...
                    download: function(t) {
                        ...
                        /iPhone|iPad|iPod/i.test(navigator.userAgent) ? window.open(i, "_blank") : this.$(".spp-downloader").prop("src", a)
                    }
                })
            }), t.Dss.DssLayout
            ...
            return t.module("News", function(t, i, s, n, a, o) {
                t.NewsLayout = n.Layout.extend({
                    ...
                    onShow: function() {
                        ...
                        a(".spp-ctct").detach().appendTo(this.$el.find(".spp-news-custom-cta")).show(), a(".spp-shsp-form-" + e.uid).detach().appendTo(this.$el.find(".spp-news-custom-cta")).show(), t.setWidthLeftAndTop(t.$el), t.setHeight(t.$el, 0), this.$el.find("img").load(function() {
            ...
            return t.module("ProgressBar", function(t, i, n, a, o, r) {
                t.ProgressBarLayout = a.Layout.extend({
                    ...
                    showTimestamp: function(t, e) {
                        ...
                        if (null !== s && s > 0 && n.hover_timestamp) {
                            var a = s * t / i / 1e3,
                                o = Math.floor(a % 60),
        ...
        function() {
                    ...
                    openEmailDialog: function(t) {
                        ...
                        a.blockUI({
                            ...
                            onOverlayClick: function() {
                                a(".spp-ctct").hide().detach().appendTo(a("body")), a(".spp-shsp-form-" + r.options.shortcode_options.uid).hide().detach().appendTo(a("body")), a.unblockUI(), r.$el.closest(".spp-player-layout").find(".spp-main-image").show()
                            }
                        });
                    ...
                    init: function() {
                        function i(t) {
                            for (var e = l.length, i = 0; i < e; i++) {
                                var s = l[i].data,
                                    n = SmartPodcastPlayer._by_uid[s.uid].mainRegion.currentView,
                                    o = t.find(function(t) {
                                        return t.uid === s.uid
                                    });
                                if (void 0 === o) s.title = "Unable to retrieve track data";
                                else if (void 0 === o.title ? s.title = "Unable to retrieve track data" : void 0 == s.title_shortcode || "" == s.title_shortcode ? s.title = o.title : s.title = s.title_shortcode, s.email = a(s.title, s.permalink), void 0 !== typeof o.artist && void 0 == s.artist && (s.artist = o.artist), "latest" == s.ajax_type && (s.url = o.stream_url, s.download_url = o.download_url, s.download_id = o.download_id), "soundcloud" == s.ajax_type) {
                                    if ("string" == typeof o.stream_url) {
                                        var r = o.stream_url.includes("?") ? "&" : "?";
                                        s.url = o.stream_url + r + "consumer_key=" + AP_Player.soundcloudConsumerKey
                                    }
                                    s.artist = s.artist || (o.user ? o.user.username : ""), s.filename = o.permalink + ".mp3", s.download_url = o.download_url, s.download_id = o.download_id
                                }
                                n.model.set({
                                    data: s
                                }), void 0 != n.loading_timer && clearInterval(n.loading_timer), n.render(), n.resize(!0)
                            }
                        }
                        var a = function(t, e) {
                                var i = "";
                        ...
                        if (o(".smart-track-player-container").each(function(i, d) {
                                var p = o(d),
                                    c = p.data("uid"),
                                    h = "SmartPodcastPlayer_uid_" + c;
                                void 0 !== window[h] && (SmartPodcastPlayer._errors[c] = window[h].errors, SmartPodcastPlayer._options[c] = window[h].options, SmartPodcastPlayer._shortcode_options[c] = window[h].shortcode_options, window[h] = void 0), void 0 === SmartPodcastPlayer._options[c] && n("SmartPodcastPlayer_uid_" + c + " not found.");
                                for (var f = 0; f < SmartPodcastPlayer._errors[c].length; f++) n(SmartPodcastPlayer._errors[c][f]);
                                var m = {
                                    method: "file"
                                };
                                for (var g in m) void 0 === SmartPodcastPlayer._options[c][g] && (SmartPodcastPlayer._options[c][g] = m[g]);
                                var v = SmartPodcastPlayer._options[c];
                                ...
                                }(y || "soundcloud" == v.method || "file" == v.method && (void 0 == v.title_shortcode || "" == v.title_shortcode)) && (v.title = 'Getting file data<span class="spp-loading-ellipsis">...</span>'), v.playing = !1, v.isStp = !0, v.isSticky = "true" === v.sticky;
                                ...
                                k.render(), b.mainRegion.show(k), k.resize(!0), k.animateStpEllipsis(), SmartPodcastPlayer._by_uid[v.uid] = b, "elapsed" === v.email_cta_open ? SmartPodcastPlayer.onTimeElapsed(function() {
                                    this.find(".spp-news").click()
                                }, v.email_cta_elapsed_seconds, v.uid) : "remaining" === v.email_cta_open && SmartPodcastPlayer.onTimeRemaining(function() {
                                    this.find(".spp-news").click()
                                }, v.email_cta_remaining_seconds, v.uid), y ? (v.ajax_type = "latest", l.push({
                                    data: v
                            ...
                            o.ajax({
                                ...
                                error: function(t, e, s) {
                                    for (var a = l.length, o = 0; o < a; o++) {
                                        var r = l[o].data,
                                            d = SmartPodcastPlayer._by_uid[r.uid].mainRegion.currentView;
                                        if (r.title = "Unable to retrieve track data", d.model.set({
                                                data: r
                                            }), void 0 != d.loading_timer && clearInterval(d.loading_timer), d.render(), d.resize(!0), "parsererror" === e) {
                                            var p = t.responseText.replace(/(\r\n|\n|\r)/gm, ""),
                                                c = /((?:<span.*\/span>)|(?:<br \/.*br \/>))(.*)/.exec(p);
                                            c && n('There was an error while retrieving the track data for URL "' + r.url + '". The error message is: ', c[1]);
                                            try {
                                                i(JSON.parse(c[2]))
                                            } catch (t) {}
                                        }
            ...
            t.module("Entities", function(t, e, i, a, o, r) {
                ...
                var d = function(t, e) {
                    ...
                    p = function(t, e, i) {
                        if ("parsererror" === e) {
                            var s = t.responseText.replace(/(\r\n|\n|\r)/gm, ""),
                                a = /(<span.*\/span>)(.*)/,
                                o = a.exec(s);
                            if (o) {
                                n("There was an error while retrieving the feed. The error message is: ", o[1]);
                                try {
                                    var r = JSON.parse(o[2]);
                                    f(r, this.invokeData.Layout, this.invokeData.playerRegion, r.length, !1)
                                } catch (t) {
                                    c(this.invokeData.playerRegion)
                                }
                            } else n("There was an error while retrieving the feed."), c(this.invokeData.playerRegion)
                        } else n("There was an error while retrieving the feed."), c(this.invokeData.playerRegion)
                    },
                    c = function(t) {
                ...
                return e.reqres.setHandler("tracks:initialize", function(t, e) {
                    var i = t.model.get("options"),
                        s = !0;
                    if ("object" == typeof SmartPodcastPlayer._cached_tracks[i.uid]) {
                        var n = SmartPodcastPlayer._cached_tracks[i.uid],
                ...
                t.FullLayout = a.Layout.extend({
                    ...
                    init: function() {
                        o(".smart-podcast-player-container, .smart-podcast-player").each(function(e, a) {
                            ...
                            if (SmartPodcastPlayer._options[l] = SmartPodcastPlayer._options[l] || window[d].options, SmartPodcastPlayer._errors[l] = SmartPodcastPlayer._errors[l] || window[d].errors, SmartPodcastPlayer._shortcode_options[l] = SmartPodcastPlayer._shortcode_options[l] || window[d].shortcode_options, window[d].cached_tracks && (SmartPodcastPlayer._cached_tracks[l] = window[d].cached_tracks), window[d] = void 0, SmartPodcastPlayer._errors[l])
                                for (var p = 0; p < SmartPodcastPlayer._errors[l].length; p++) n(SmartPodcastPlayer._errors[l][p]);
                            var c = {
                                consumer_key: AP_Player.soundcloudConsumerKey,
                                current_page: 1,
                                tracks_per_page: 10
                            };
                            for (var u in c) void 0 === SmartPodcastPlayer._options[l][u] && (SmartPodcastPlayer._options[l][u] = c[u]);
                            sppOptions = SmartPodcastPlayer._options[l], !1 === sppOptions.social_twitter && !1 === sppOptions.social_facebook && !1 === sppOptions.social_linkedin && !1 === sppOptions.social_gplus && !1 === sppOptions.social_pinterest && !1 === sppOptions.social_email && (sppOptions.social = !1), "false" !== sppOptions.subscribe_rss && (sppOptions.subscribe_rss = sppOptions.url),
                            ...
                            SmartPodcastPlayer._by_uid[sppOptions.uid] = h, "elapsed" === sppOptions.email_cta_open ? SmartPodcastPlayer.onTimeElapsed(function() {
                                this.find(".spp-news").click()
                            }, sppOptions.email_cta_elapsed_seconds, sppOptions.uid) : "remaining" === sppOptions.email_cta_open && SmartPodcastPlayer.onTimeRemaining(function() {
                                this.find(".spp-news").click()
                            }, sppOptions.email_cta_remaining_seconds, sppOptions.uid), o(a).removeClass("smart-podcast-player-container"), o(a).addClass("smart-podcast-player");
        ...
        function(t) {
            ...
            return t.module("Playlist", function(t, n, o, r, l, d) {
                ...
                } else n("Tracks added before playlist init in uid " + i.uid)
                ...
                t.ajax({
                    ...
                    success: function(t) {
                        for (i = 0; i < t.length; i++) {
                            var e = t[i];
                            window["SmartPodcastPlayer_uid_" + e.uid] = e
                        }
                    },
                    failure: function() {
